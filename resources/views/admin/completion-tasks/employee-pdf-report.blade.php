    ...
    @foreach($data['tasks'] as $key => $all_task)
        ...
        <div class="page-break">
            ...
            <table class="table table-border">
                <tr>
                    <td class="border border-5 border-dark"><b>{{$data['user']->first_name}} {{$data['user']->last_name}}</b></td>
                ...
                <tr>
                    ...
                    @foreach($all_task as $h_task)
                        <td class="bg-warning border border-5 border-dark text-center"><b>{{ $h_task->hasFacility->name }}</b></td>
                    @endforeach
                </tr>
                @php 
                    $bool = true; 
