...
@push('js')
    ...
    <script>
        ...
        $(document).on('change', '#flatpickr-range', function(e) {
            ...
            $.ajax({
                url:'{{ url("completion_tasks_report") }}',
                method:'GET',
        ...
        $(document).on('click', '#generate_pdf', function(e){
            ...
            Url ='{{ route("generate-pdf-report-facility") }}?date='+date+'&facility_id='+facility_id+'&room_id='+room_id
            if((date!="" && facility_id!="") && room_id!=""){
                $.ajax({
                    url:'{{ url("generate_pdf_report_facility") }}',
                    method:'GET',
                    data:{date:date, facility_id:facility_id, room_id:room_id,},
                    success: function(response) {
