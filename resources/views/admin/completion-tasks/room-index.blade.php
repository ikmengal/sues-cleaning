                    ...
                    <div class="d-flex justify-content-end align-item-center mt-4">
                        <!-- <div class="dt-buttons btn-group flex-wrap">
                            <button
                                ...
                                data-placement="top"
                                title=""
                                data-url="{{-- route('generate_excel_report') --}}"
                                type="button"
                                id="gerenate_excel"
                                >
                        ...
                        <div class="dt-buttons btn-group flex-wrap">
                            <button
                                ...
                                data-placement="top"
                                title=""
                                data-url="{{-- route('generate_pdf_report') --}}"
                                type="button"
                                id="gerenate_pdf"
                                >
...
@push('js')
    ...
    <script>
        ...
        $(document).on('change', '#facility_status', function(e) {
            ...
            $.ajax({
                url:'{{ url("completion_room_report") }}',
                method:'GET',
        ...
        $(document).on('click', '#gerenate_pdf', function(e){
            ...
            Url ='{{ route("generate-pdf-report") }}?date='+date+'&facility_id='+facility_id+'&room_id='+room_id
        ...
        //     $.ajax({
        //         url:'{{ url("assign_the_room_to_user") }}',
        //         method:'GET',
        ...
        //     Url = Url ='{{ route("generate-pdf-report") }}?date='+date+'&facility_id='+facility_id+'&room_id='+room_id
        //     if((date!="" && facility_id!="") && room_id!=""){
        //         $.ajax({
        //             url:'{{ url("generate_pdf_report") }}',
        //             method:'GET',
        //             data:{date:date, facility_id:facility_id, room_id:room_id,},
        //             success: function(response) {
        //                 console.log(response);
        ...
        $(document).on('change', '#select_model_user', function(e){
            ...
            $.ajax({
                url:'{{ url("room_detail_as_select_user") }}',
                method: 'GET',
