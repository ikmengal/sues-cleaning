    ...
    <div class="row">
      ...
      <!-- Revenue Generated -->
        ...
        <div class="col-lg-3 col-md-6 col-sm-6 mb-4">
            <a href="{{ url('employees') }}" style="color:gray">
                <div class="card">
                  <div class="card-body pb-4">
                    ...
                    <h5 class="card-title mb-0 mt-2 p-2">{{$data['users']}}</h5>
        ...
        <div class="col-lg-3 col-md-6 col-sm-6 mb-4">
            <a href="{{ url('facilities') }}" style="color:gray">
                <div class="card">
                  <div class="card-body pb-4">
                    <div class="card-icon">
                      <span class="badge bg-label-success rounded-pill p-2">
                    ...
                    <h5 class="card-title mb-0 mt-2 p-2">{{$data['facilities']}}</h5>
        ...
        <div class="col-lg-3 col-md-6 col-sm-6 mb-4">
            <a href="{{ url('services') }}" style="color:gray">
                <div class="card">
                  <div class="card-body pb-4">
                    <div class="card-icon">
                      <span class="badge bg-label-success rounded-pill p-2">
                    ...
                    <h5 class="card-title mb-0 mt-2 p-2">{{$data['services']}}</h5>
        ...
        <div class="col-lg-3 col-md-6 col-sm-6 mb-4">
            <a href="{{ url('tasks') }}" style="color:gray">    
                <div class="card">
                  <div class="card-body pb-4">
                    <div class="card-icon">
                      <span class="badge bg-label-success rounded-pill p-2">
                    ...
                    <h5 class="card-title mb-0 mt-2 p-2">{{$data['tasks']}}</h5>
