                                ...
                                <div class="card-body">
                                    <form action="{{ route('tasks.store') }}" method="post">
                                        ...
                                        <div class="mb-3 fv-plugins-icon-container">
                                            ...
                                            <span id="employee_id_error" class="text-danger error">{{ $errors->first('employee_id') }}</span>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-6 mb-3 fv-plugins-icon-container">
                                                ...
                                                />
                                                <div class="fv-plugins-message-container invalid-feedback"></div>
                                                <span id="date_error" class="text-danger error">{{ $errors->first('start-date') }}</span>
                                            </div>
                                            <div class="col-6 mb-3 fv-plugins-icon-container">
                                                ...
                                                />
                                                <div class="fv-plugins-message-container invalid-feedback"></div>
                                                <span id="date_error" class="text-danger error">{{ $errors->first('enddate') }}</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3 fv-plugins-icon-container">
                                            ...
                                            <select name="facility_id" id="facility_id" class="form-control">
                                                ...
                                                @foreach ($data['facilities'] as $facility)
                                                    dd($facility)
                                                    <option value="{{ $facility->id }}" data-url="{{ route('tasks.get-facility-rooms', $facility->id) }}">{{ $facility->name }}</option>
                                                @endforeach
                                            </select>
                                            <div class="fv-plugins-message-container invalid-feedback"></div>
                                            <span id="facility_id_error" class="text-danger error">{{ $errors->first('facility_id') }}</span>
                                        </div>
                                        ...
                                        <div class="mb-3 fv-plugins-icon-container">
                                            ...
                                            <div class="fv-plugins-message-container invalid-feedback"></div>
                                            <span id="facility_room_id_error" class="text-danger error">{{ $errors->first('facility_room_id') }}</span>
                                        </div>
                                        ...
                                        <div class="mb-3 fv-plugins-icon-container mt-3">
                                            ...
                                            <div class="fv-plugins-message-container invalid-feedback"></div>
                                            <span id="comment_error" class="text-danger error">{{ $errors->first('comment') }}</span>
                                        </div>
                    ...
                    success: function(response) {    
                        ...
                        if(response){
                            ...
                            $.each(response, function(index, value) {
                                html += '<option value="'+value.id+'" data-url="{{ route("tasks.get-facility-tasks") }}">'+value.name+'</option>';
                            });
