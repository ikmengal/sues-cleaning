...
<?php $__env->startPush('js'); ?>
    ...
    <script>
        ...
        //         $.ajax({
        //             url:'<?php echo e(url("completion_task_mployee_room")); ?>',
        //             method:'GET',
        //             data:{date:date, user_id:user_id},
        //             success: function(response) {
        ...
        $(document).on('click', '#generate_pdf', function(e){
            ...
            Url ='<?php echo e(route("generate-pdf-report-employee")); ?>?date='+date+'&user_id='+user_id+'&room_id='+room_id
            if(date!="" && user_id!=""){
                $.ajax({
                    url:'<?php echo e(url("generate_pdf_report_employee")); ?>',
                    method:'GET',
                    data:{date:date, user_id:user_id, room_id:room_id,},
                    success: function(response) {
                        console.log(response);
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dotverge/public_html/suescleaning.dotverge.com/resources/views/admin/completion-tasks/employee-index.blade.php ENDPATH**/ ?>