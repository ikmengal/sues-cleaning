<table class="table">
    ...
    <tbody>
        ...
        <tr>
            <th colspan="5"><b>Room -> <u><?php echo e($data['task']->hasRoom->name); ?></u></b></th>
        </tr>
        <tr>
            <td colspan="5">
                <table class="table">
        ...
        <tr>
            <td colspan="4"><?php echo e($data['task']->comment??'-'); ?></td>
        </tr>
        <tr style="border-bottom:hidden">
            <th colspan="4">EXTRA HOURS</th>
        </tr>
        <tr>
            <td colspan="4"><?php echo e($data['task']->extra_hours??'-'); ?></td>
        </tr>
                ...
                <td colspan="4">
                    <div class="row">
                        <?php $__currentLoopData = $data['picturs']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task_picture): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-4 image_popup cursor-pointer" imagedata="<?php echo e(asset('public/admin/assets/img/task_pictures')); ?>/<?php echo e($task_picture->picture); ?>">
...
</script><?php /**PATH C:\xampp\htdocs\suescleaning.dotverge.com\resources\views/admin/tasks/show_content.blade.php ENDPATH**/ ?>