    ...
    <div class="row">
      ...
      <!-- Revenue Generated -->
        ...
        <div class="col-lg-3 col-md-6 col-sm-6 mb-4">
            <a href="<?php echo e(url('employees')); ?>" style="color:gray">
                <div class="card">
                  <div class="card-body pb-4">
                    ...
                    <h5 class="card-title mb-0 mt-2 p-2"><?php echo e($data['users']); ?></h5>
                    <small class="p-2">Total Employees</small>                
                  </div>
                </div>
            </a>    
        </div>
        ...
        <div class="col-lg-3 col-md-6 col-sm-6 mb-4">
            <a href="<?php echo e(url('facilities')); ?>" style="color:gray">
                <div class="card">
                  <div class="card-body pb-4">
                    <div class="card-icon">
                      <span class="badge bg-label-success rounded-pill p-2">
                    ...
                    <h5 class="card-title mb-0 mt-2 p-2"><?php echo e($data['facilities']); ?></h5>
                    <small class="p-2">Total Facilities</small>
                  </div>
                </div>
            </a>    
      </div>
        ...
        <div class="col-lg-3 col-md-6 col-sm-6 mb-4">
            <a href="<?php echo e(url('services')); ?>" style="color:gray">
                <div class="card">
                  <div class="card-body pb-4">
                    <div class="card-icon">
                      <span class="badge bg-label-success rounded-pill p-2">
                    ...
                    <h5 class="card-title mb-0 mt-2 p-2"><?php echo e($data['services']); ?></h5>
                    <small class="p-2">Total Services</small>
                  </div>
                </div>
            </a>
      </div>
        ...
        <div class="col-lg-3 col-md-6 col-sm-6 mb-4">
            <a href="<?php echo e(url('tasks')); ?>" style="color:gray">    
                <div class="card">
                  <div class="card-body pb-4">
                    <div class="card-icon">
                      <span class="badge bg-label-success rounded-pill p-2">
                    ...
                    <h5 class="card-title mb-0 mt-2 p-2"><?php echo e($data['tasks']); ?></h5>
                    <small class="p-2">Total Tasks</small>
                  </div>
                </div>
            </a>
      </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dotverge/public_html/suescleaning.dotverge.com/resources/views/admin/dashboards/admin-dashboard.blade.php ENDPATH**/ ?>