                    ...
                    <div class="d-flex justify-content-end align-item-center mt-4">
                        <div class="dt-buttons btn-group flex-wrap">
                            <button
                                ...
                                id="add-btn"
                                data-url="<?php echo e(route('facilities.store')); ?>"
                ...
                <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
                    <div class="container">
                        <table class="datatables-users table border-top dataTable no-footer dtr-column" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info" style="width: 1227px;">
                            ...
                            <tbody id="body">
                                <?php $__currentLoopData = $data['facilities']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$facility): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="odd" id="id-<?php echo e($facility->slug); ?>">
                                        <td tabindex="0"><?php echo e($data['facilities']->firstItem()+$key); ?>.</td>
                                        <td>
                                        ...
                                        <td>
                                            <span class="fw-semibold">
                                                <?php echo e($facility->email??'-'); ?>

                                            </span>
                                        </td>
                                        <td>
                                            <span class="fw-semibold">
                                                <?php echo e($facility->phone_number??'-'); ?>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <a href="<?php echo e(route('facility_rooms.index', ['facility_slug' => $facility->slug])); ?>" style="color: white" class="btn btn-secondary btn-sm btn-primary mx-3 waves-effect waves-light" title="All Rooms" >
                                                    <span>
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end m-0">
                                                    <a href="javascript:;" class="dropdown-item change-status-btn" data-status-type="status" data-status-url='<?php echo e(route('facilities.status', $facility->slug)); ?>'>
                                                        <?php if($facility->status): ?>
                                                            De-Active
                                                        <?php else: ?>
                                                            Active
                                                    ...
                                                    <a href="#"
                                                        ...
                                                        data-show-url="<?php echo e(route('facilities.show', $facility->slug)); ?>"
                                                        >
                                                        View Details
                                                    </a>
                                                    <a href="#"
                                                        ...
                                                        data-placement="top"
                                                        title="Edit Employee"
                                                        data-edit-url="<?php echo e(route('facilities.edit', $facility->slug)); ?>"
                                                        data-url="<?php echo e(route('facilities.update', $facility->slug)); ?>"
                                                        tabindex="0" aria-controls="DataTables_Table_0"
                                                        type="button" data-bs-toggle="modal"
                                                        data-bs-target="#create-form-modal"
                                                        >
                                                    ...
                                                    <a href="#"
                                                        ...
                                                        data-slug="<?php echo e($facility->slug); ?>"
                                                        data-del-url="<?php echo e(route('facilities.destroy', $facility->slug)); ?>"
                                                        >
                                                        Delete
                                                    </a>
                                                </div>
                                    ...
                                    <td colspan="8">
                                        <div class="row mx-2">
                                            <div class="col-sm-12 col-md-6">
                                                <div class="dataTables_info" id="DataTables_Table_0_info" role="status" aria-live="polite">Showing <?php echo e($data['facilities']->firstItem()); ?> to <?php echo e($data['facilities']->lastItem()); ?> of <?php echo e($data['facilities']->total()); ?> entries</div>
                                            </div>
                                            <div class="col-sm-12 col-md-6">
                                                <div class="dataTables_paginate paging_simple_numbers" id="DataTables_Table_0_paginate">
                                                    <?php echo $data['facilities']->links('pagination::bootstrap-4'); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dotverge/public_html/suescleaning.dotverge.com/resources/views/admin/facilities/index.blade.php ENDPATH**/ ?>