    ...
    <?php $__currentLoopData = $data['tasks']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $all_task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="page-break">
            ...
            <table class="table table-border">
                <tr>
                    <td class="border border-5 border-dark"><b><?php echo e($data['user']->first_name); ?> <?php echo e($data['user']->last_name); ?></b></td>
                ...
                <tr>
                    ...
                    <?php $__currentLoopData = $all_task; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $h_task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <td class="bg-warning border border-5 border-dark text-center"><b><?php echo e($h_task->hasFacility->name); ?></b></td>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </tr>
                <?php 
                    $bool = true; 
...
</html><?php /**PATH /home/dotverge/public_html/suescleaning.dotverge.com/resources/views/admin/completion-tasks/employee-pdf-report.blade.php ENDPATH**/ ?>