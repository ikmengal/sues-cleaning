...
<?php $__currentLoopData = $data['user']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <?php $counter++; ?>
    <tr class="odd" id="id-<?php echo e($user->id); ?>">
        ...
        <td>
            <div class="d-flex align-items-center">
                    <a href="javascript:;" 
                        ...
                        data-placement="top" 
                        title="Room Details" 
                        data-show-url="<?php echo e(route('completion-room-detaile', $data['task'][$key]->id)); ?>" 
                        data-url="" 
                        tabindex="0" 
...
</tr><?php /**PATH /home/dotverge/public_html/suescleaning.dotverge.com/resources/views/admin/completion-tasks/show-room-table.blade.php ENDPATH**/ ?>